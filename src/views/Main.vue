    ...
    <el-container>
      <!--左侧的菜单栏-->
        <el-aside style="width:200px">
         <el-menu :default-opened="defaultOpeneds" :default-active="defaultActive" :unique-opened="true" :router="true">
        <!--菜单项1-->
          ...
          <el-submenu index="dish">
            ...
            <el-menu-item-group>
              ...
              <el-menu-item index="/dish/update">删除菜品</el-menu-item>
              <el-menu-item index="/dish/delete">修改菜品</el-menu-item>
            </el-menu-item-group>
          </el-submenu>
...
<script>
  import MainHeader from '../components/MainHeader'
   export default {
     ...
     //create/mounte/uodate/destory
     beforeCreate(){
       //main组件创建之前要先检查是否已经登录为管理员
